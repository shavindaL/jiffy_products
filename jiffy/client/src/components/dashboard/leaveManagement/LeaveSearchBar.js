...
function SearchBar(props) {
    ...
    const [searchCategory, setSearchCategory] = useState("leaveType");
            ...
            <div className="col-4">
                <div className="input-group mb-3">
                    ...
                    <select className="form-select" onChange={e => setSearchCategory(e.target.value)}>
                        <option value="leaveType" defaultValue={"leaveType"}>Leave Type</option>
                        <option value="leaveDesc">Description</option>
                    </select>
