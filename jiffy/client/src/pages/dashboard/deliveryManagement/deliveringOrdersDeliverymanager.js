...
import Deliveries from '../../../components/dashboard/deliveryManagement/DeliveryListforDelivering';



function DeliveringOrdersDeliverymanager() {
        ...
        useEffect(() => {
            const handleSearch = () => {
                ...
                const fetchAllDeliveries = async () => {
                    const response = await fetch("/api/orders//deliveryStatus/delivering");
                    const json = await response.json();
...
export default DeliveringOrdersDeliverymanager;